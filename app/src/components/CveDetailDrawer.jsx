export default function CveDetailDrawer({ cve, onClose }) {
  return (
    <div className={`cve-modal ${cve ? "open" : ""}`} aria-label="CVE details">
      <div className="cve-modal__backdrop" onClick={onClose} />
      <div className="cve-modal__card">
        ...
        {cve ? (
          ...
          <p className="text-muted">Click a CVE node to see details.</p>
        )}
      </div>
    </div>
  );
