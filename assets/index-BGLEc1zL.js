 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(T,L){var O=T.length;T.push(L);e:for(;0<O;){var $=O-1>>>1,q=T[$];if(0<i(q,L))T[$]=L,T[O]=q,O=$;else break e}}function t(T){return T.length===0?null:T[0]}function r(T){if(T.length===0)return null;var L=T[0],O=T.pop();if(O!==L){T[0]=O;e:for(var $=0,q=T.length,dr=q>>>1;$<dr;){var Sn=2*($+1)-1,ji=T[Sn],bn=Sn+1,fr=T[bn];if(0>i(ji,O))bn<q&&0>i(fr,ji)?(T[$]=fr,T[bn]=O,$=bn):(T[$]=ji,T[Sn]=O,$=Sn);else if(bn<q&&0>i(fr,O))T[$]=fr,T[bn]=O,$=bn;else break e}}return L}function i(T,L){var O=T.sortIndex-L.sortIndex;return O!==0?O:T.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,s=o.now();e.unstable_now=function(){return o.now()-s}}var a=[],u=[],g=1,h=null,m=3,v=!1,w=!1,k=!1,E=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(T){for(var L=t(u);L!==null;){if(L.callback===null)r(u);else if(L.startTime<=T)r(u),L.sortIndex=L.expirationTime,n(a,L);else break;L=t(u)}}function y(T){if(k=!1,p(T),!w)if(t(a)!==null)w=!0,Li(b);else{var L=t(u);L!==null&&Oi(y,L.startTime-T)}}function b(T,L){w=!1,k&&(k=!1,f(N),N=-1),v=!0;var O=m;try{for(p(L),h=t(a);h!==null&&(!(h.expirationTime>L)||T&&!_e());){var $=h.callback;if(typeof $=="function"){h.callback=null,m=h.priorityLevel;var q=$(h.expirationTime<=L);L=e.unstable_now(),typeof q=="function"?h.callback=q:h===t(a)&&r(a),p(L)}else r(a);h=t(a)}if(h!==null)var dr=!0;else{var Sn=t(u);Sn!==null&&Oi(y,Sn.startTime-L),dr=!1}return dr}finally{h=null,m=O,v=!1}}var P=!1,_=null,N=-1,W=5,R=-1;function _e(){return!(e.unstable_now()-R<W)}function gt(){if(_!==null){var T=e.unstable_now();R=T;var L=!0;try{L=_(!0,T)}finally{L?vt():(P=!1,_=null)}}else P=!1}var vt;if(typeof d=="function")vt=function(){d(gt)};else if(typeof MessageChannel<"u"){var es=new MessageChannel,Gc=es.port2;es.port1.onmessage=gt,vt=function(){Gc.postMessage(null)}}else vt=function(){E(gt,0)};function Li(T){_=T,P||(P=!0,vt())}function Oi(T,L){N=E(function(){T(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(T){T.callback=null},e.unstable_continueExecution=function(){w||v||(w=!0,Li(b))},e.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<T?Math.floor(1e3/T):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(a)},e.unstable_next=function(T){switch(m){case 1:case 2:case 3:var L=3;break;default:L=m}var O=m;m=L;try{return T()}finally{m=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(T,L){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var O=m;m=T;try{return L()}finally{m=O}},e.unstable_scheduleCallback=function(T,L,O){var $=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?$+O:$):O=$,T){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=O+q,T={id:g++,callback:L,priorityLevel:T,startTime:O,expirationTime:q,sortIndex:-1},O>$?(T.sortIndex=O,n(u,T),t(a)===null&&T===t(u)&&(k?(f(N),N=-1):k=!0,Oi(y,O-$))):(T.sortIndex=q,n(a,T),w||v||(w=!0,Li(b))),T},e.unstable_shouldYield=_e,e.unstable_wrapCallback=function(T){var L=m;return function(){var O=m;m=L;try{return T.apply(this,arguments)}finally{m=O}}}})(Aa);Ra.exports=Aa;var vd=Ra.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function eo(){return eo=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},eo.apply(this,arguments)}function gh(e,n){if(e==null)return{};var t={},r=Object.keys(e),i,l;for(l=0;l<r.length;l++)i=r[l],!(n.indexOf(i)>=0)&&(t[i]=e[i]);return t}function vh(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function yh(e,n){return e.button===0&&(!n||n==="_self")&&!vh(e)}const wh=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],kh="6";try{window.__reactRouterVersion=kh}catch{}const xh="startTransition",ga=cd[xh];function Sh(e){let{basename:n,children:t,future:r,window:i}=e,l=S.useRef();l.current==null&&(l.current=bp({window:i,v5Compat:!0}));let o=l.current,[s,a]=S.useState({action:o.action,location:o.location}),{v7_startTransition:u}=r||{},g=S.useCallback(h=>{u&&ga?ga(()=>a(h)):a(h)},[a,u]);return S.useLayoutEffect(()=>o.listen(g),[o,g]),S.useEffect(()=>ph(r),[r]),S.createElement(hh,{basename:n,children:t,location:s.location,navigationType:s.action,navigator:o,future:r})}const bh=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Eh=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ue=S.forwardRef(function(n,t){let{onClick:r,relative:i,reloadDocument:l,replace:o,state:s,target:a,to:u,preventScrollReset:g,viewTransition:h}=n,m=gh(n,wh),{basename:v}=S.useContext(Bn),w,k=!1;if(typeof u=="string"&&Eh.test(u)&&(w=u,bh))try{let p=new URL(window.location.href),y=u.startsWith("//")?new URL(p.protocol+u):new URL(u),b=Jo(y.pathname,v);y.origin===p.origin&&b!=null?u=b+y.search+y.hash:k=!0}catch{}let E=qp(u,{relative:i}),f=Ch(u,{replace:o,state:s,target:a,preventScrollReset:g,relative:i,viewTransition:h});function d(p){r&&r(p),p.defaultPrevented||f(p)}return S.createElement("a",eo({},m,{href:w||E,onClick:k||l?r:d,ref:t,target:a}))});var va;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(va||(va={}));var ya;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(ya||(ya={}));function Ch(e,n){let{target:t,replace:r,state:i,preventScrollReset:l,relative:o,viewTransition:s}=n===void 0?{}:n,a=Uc(),u=cr(),g=Hc(e,{relative:o});return S.useCallback(h=>{if(yh(h,t)){h.preventDefault();let m=r!==void 0?r:fi(u)===fi(g);a(e,{replace:m,state:i,preventScrollReset:l,relative:o,viewTransition:s})}},[u,a,g,r,i,t,e,l,o,s])}function Th({onToggleTheme:e,theme:n}){const t=cr(),r=Uc(),i=t.pathname==="/blogs",l=t.pathname.startsWith("/projects"),o=t.pathname.startsWith("/certifications"),s=t.hash==="#contact"||t.pathname==="/contact",a=(u,g)=>{u.preventDefault();const h=()=>{const m=document.getElementById(g);m&&m.scrollIntoView({behavior:"smooth",block:"start"})};t.pathname!=="/"?(r("/"),setTimeout(h,80)):h()};return c.jsx("nav",{className:"navbar",children:c.jsxs("div",{className:"container nav-container",children:[c.jsx("div",{className:"logo",children:"Hem Parekh"}),c.jsxs("ul",{className:"nav-links",children:[c.jsx("li",{children:c.jsx("a",{href:"#about",onClick:u=>a(u,"about"),children:"About"})}),c.jsx("li",{children:c.jsx("a",{href:"#experience",onClick:u=>a(u,"experience"),children:"Experience"})}),c.jsx("li",{children:c.jsx(Ue,{to:"/projects",className:l?"active":"",children:"Projects"})}),c.jsx("li",{children:c.jsx(Ue,{to:"/certifications",className:o?"active":"",children:"Certs"})}),c.jsx("li",{children:c.jsx("a",{href:"https://drive.google.com/file/d/18iXELe1Bge8-SSpKBscATGjY4rCicmNb/view?usp=sharing",target:"_blank",rel:"noreferrer",children:"Resume"})}),c.jsx("li",{children:c.jsx(Ue,{to:"/blogs",className:i?"active":"",children:"Blog"})}),c.jsx("li",{children:c.jsx("a",{href:"#contact",className:s?"active":"",onClick:u=>a(u,"contact"),children:"Contact"})})]}),c.jsx("button",{className:"theme-toggle",id:"themeToggle",onClick:e,children:n==="dark"?"Light Mode":"Dark Mode"})]})})}function Ph(){return c.jsx("footer",{className:"footer",children:c.jsx("div",{className:"container",children:c.jsx("p",{children:"© 2024 Hem Parekh | All rights reserved."})})})}function _h({data:e}){return c.jsx("header",{className:"hero",id:"home",children:c.jsxs("div",{className:"hero-content container",children:[c.jsxs("h1",{children:["Hello, I'm ",c.jsx("span",{className:"highlight",children:e.highlight}),"."]}),c.jsxs("div",{className:"hero-descriptors",children:[c.jsx("span",{className:"pill",children:"Security Engineer"}),c.jsx("span",{className:"pill",children:"Pen Tester"})]}),c.jsx("img",{src:e.image,className:"heading-image",alt:"Heading"}),c.jsx("p",{children:e.blurb}),c.jsxs("div",{className:"hero-ctas",children:[c.jsx(Ue,{className:"button primary",to:"/projects",children:"View Projects"}),c.jsx(Ue,{className:"button ghost",to:"/certifications",children:"View Certifications"})]}),c.jsx("div",{className:"scroll-down-arrow",children:c.jsx("a",{href:"#about",className:"arrow-link",children:c.jsx("span",{children:"↓"})})})]})})}function Nh({links:e=[]}){return c.jsx("div",{className:"social-icons",children:e.map(n=>c.jsx("a",{href:n.href,target:"_blank",rel:"noreferrer","aria-label":n.label||"Social link",children:c.jsx("i",{className:n.icon})},n.href))})}function Lh({data:e,socials:n}){return c.jsx("section",{className:"about",id:"about",children:c.jsxs("div",{className:"container about-container",children:[c.jsx("div",{className:"about-photo",children:c.jsx("img",{src:e.image,alt:"Hem Parekh",style:{maxWidth:"100%",borderRadius:"10px"}})}),c.jsxs("div",{className:"about-content",children:[c.jsx("h2",{children:e.title}),c.jsx("p",{children:e.text}),c.jsx(Nh,{links:n})]})]})})}const Oh={"Privacy Engineer":{domains:["Privacy","Cloud"],impact:"High",capabilities:{"Privacy Reviews":!0,"Threat Modeling":!0,Automation:!0,Compliance:!0,"Incident Response":!1,"Pen Testing":!1},tools:["AWS","Splunk","Python","Terraform"],outcome:"Cut data exposure paths; embedded privacy-by-design across services.",actions:["Ran DPIAs and embedded data minimization controls into SDLC checkpoints.","Built automated privacy checks; closed data leakage pathways with teams.","Partnered with engineering to enforce retention and access boundaries."]},"Cybersecurity Engineer Intern":{domains:["AppSec","Infra"],impact:"High",capabilities:{"Pen Testing":!0,"Threat Modeling":!0,Automation:!0,Compliance:!0,"Incident Response":!1,"Privacy Reviews":!1},tools:["Burp","ZAP","k6","GitHub Actions"],outcome:"8 critical issues fixed; 25+ web apps hardened.",actions:["Performed web app testing and prioritized fixes with teams.","Automated scans and performance baselines in CI pipelines.","Authored NIST-27001-ready documentation to support compliance."]},"Research Assistant":{domains:["Research","Compliance"],impact:"Medium",capabilities:{Compliance:!0,"Threat Modeling":!0,"Privacy Reviews":!0,Automation:!1,"Pen Testing":!1,"Incident Response":!1},tools:["NIST 800-53","ISO 27001","Python"],outcome:"Risk assessments aligned to NIST/ISO; controls implemented with teams.",actions:["Conducted risk assessments mapped to NIST SP 800-53 and ISO/IEC 27001.","Worked with stakeholders to implement mitigating controls.","Documented findings and recommendations for research systems."]},"Cybersecurity Analyst Intern":{domains:["AppSec","Infra"],impact:"Medium",capabilities:{"Pen Testing":!0,"Threat Modeling":!0,Compliance:!0,Automation:!1,"Incident Response":!1,"Privacy Reviews":!1},tools:["Nessus","Burp","Splunk"],outcome:"Assessed 18 internal systems; delivered remediation guidance.",actions:["Executed vulnerability assessments and penetration tests on internal systems.","Delivered remediation guidance and tracked fixes with engineers.","Supported creation of NIST-27001-compliant documentation."]},"Security Operational Analyst (SOC)":{domains:["Detection","Operations"],impact:"Medium",capabilities:{"Incident Response":!0,"Threat Modeling":!1,"Pen Testing":!1,Compliance:!1,Automation:!0,"Privacy Reviews":!1},tools:["SIEM","IDS/IPS","SOAR"],outcome:"Monitored 100+ devices; improved alert handling and root-cause analysis.",actions:["Monitored security telemetry across 100+ devices and responded to alerts.","Performed root-cause analysis on incidents and tuned detections.","Streamlined triage by automating routine checks."]}};function jh({items:e}){return c.jsx("section",{className:"experience",id:"experience",children:c.jsxs("div",{className:"container",children:[c.jsx("div",{className:"section-header",children:c.jsx("div",{children:c.jsx("h2",{children:"EXPERIENCE"})})}),c.jsx("div",{className:"experience-grid",children:e.map(n=>{const t=Oh[n.role]||{},r=t.domains||[],i=t.capabilities||{},l=t.tools||[],o=t.actions||[n.desc];return c.jsxs("article",{className:"exp-card",children:[c.jsxs("header",{className:"exp-card-header",children:[c.jsxs("div",{children:[c.jsx("h3",{children:n.role}),c.jsx("h4",{children:n.org})]}),c.jsx("div",{className:"exp-dates",children:n.range})]}),c.jsxs("div",{className:"exp-chips",children:[r.map(s=>c.jsx("span",{className:"pill",children:s},s)),t.impact&&c.jsxs("span",{className:"pill impact",children:["Impact: ",t.impact]})]}),c.jsx("div",{className:"exp-outcome",children:t.outcome||n.desc}),c.jsx("div",{className:"exp-capabilities",children:Object.entries(i).map(([s,a])=>c.jsxs("div",{className:`exp-cap ${a?"on":"off"}`,children:[c.jsx("span",{className:"dot-cap"}),s]},s))}),c.jsxs("div",{className:"exp-tools",children:[c.jsx("span",{className:"exp-tools-label",children:"Tools:"}),c.jsx("div",{className:"exp-tools-list",children:l.map(s=>c.jsx("span",{className:"pill",children:s},s))})]}),c.jsx("ul",{className:"exp-actions",children:o.map(s=>c.jsx("li",{children:s},s))})]},`${n.range}-${n.role}`)})})]})})}const Rh=[{href:"https://github.com/Hem1700",icon:"fab fa-github",label:"GitHub"},{href:"https://www.linkedin.com/in/hem-parekh/",icon:"fab fa-linkedin-in",label:"LinkedIn"},{href:"https://medium.com/@hemparekh1596",icon:"fab fa-medium",label:"Medium"},{href:"https://tryhackme.com/r/p/beatmonk",icon:"fas fa-terminal",label:"TryHackMe"},{href:"https://app.hackthebox.com/profile/overview",icon:"fas fa-user-secret",label:"HackTheBox"}],Ah={title:"Hello, I'm Hem Parekh.",highlight:"Hem Parekh",image:"/images/heading_image.webp",blurb:"I’m a Security Engineer & Pen Tester, enthusiastic about building robust software and hunting vulnerabilities."},Mh={title:"ABOUT ME",image:"/images/profile.jpeg",text:`I’m Hem Parekh, a Security Engineer and Pen Tester who thrives on building robust software 
...
</html>`,nm={firmware_llm_annotator:{title:"Firmware Exploration: LLM as Your Annotator",slug:"firmware_llm_annotator",content:qh},1001:{title:"CVE-2024–1001",slug:"1001",content:Gh},"0012":{title:"CVE-2024–0012",slug:"0012",content:Wh},40982:{title:"CVE-2022–40982",slug:"40982",content:Yh},cow:{title:"CVE-2016–5195",slug:"cow",content:Xh},symlinks:{title:"Symbolic Links (Symlinks) in Linux",slug:"symlinks",content:em},23397:{title:"CVE-2023–23397",slug:"23397",content:Kh},"0160":{title:"CVE-2014-0160",slug:"0160",content:$h},11882:{title:"CVE-2017-11882",slug:"11882",content:Qh},robot:{title:"ROBOT (Return of Bleichenbacher’s Oracle Threat) Attack",slug:"robot",content:Zh},poodle:{title:"ZOMBIE POODLE and GOLDENDOODLE ATTACKS",slug:"poodle",content:Jh}};function tm(e){try{const t=new DOMParser().parseFromString(e,"text/html"),r=["style","script","link","nav","header","footer",".navbar",".nav-container",".theme-toggle",".footer",".social-links",".social-icons"];t.querySelectorAll(r.join(",")).forEach(s=>s.remove()),t.querySelectorAll("[style]").forEach(s=>s.removeAttribute("style"));const i=t.querySelector("h1");i&&i.remove();const l=[".blog-text","article",".blog-post-content","main"];let o=t.body;for(const s of l){const a=t.querySelector(s);if(a){o=a;break}}return o.querySelectorAll(".container").forEach(s=>{for(;s.firstChild;)s.parentNode.insertBefore(s.firstChild,s);s.remove()}),Array.from(o.querySelectorAll("h2, h3")).forEach((s,a)=>{s.id||(s.id=`section-${a+1}`)}),o.innerHTML||e}catch{return e}}function rm(){const{slug:e}=Zp(),n=nm[e],t=no.find(i=>i.slug===e),r=S.useMemo(()=>n?tm(n.content):"",[n]);return n?c.jsxs(c.Fragment,{children:[c.jsx("header",{className:"blog-post-header",children:c.jsxs("div",{className:"container text-center",children:[c.jsx("h1",{className:"blog-post-title",children:n.title}),t&&c.jsxs("p",{className:"blog-post-date",children:[t.date," · ",t.readTime]})]})}),c.jsx("main",{className:"blog-post-content container",children:c.jsx("article",{dangerouslySetInnerHTML:{__html:r}})})]}):c.jsxs("main",{className:"blog-post-content container",children:[c.jsx("h2",{children:"Post not found"}),c.jsx("p",{children:"The post you’re looking for does not exist."}),c.jsx(Ue,{to:"/blogs",className:"view-credentials",children:"Back to Blog"})]})}const im=["All","Security Tools","Research","Web","Desktop","Cloud","Automation"];function lm({activeFilter:e,onFilterChange:n}){return c.jsx("div",{className:"filter-chips",children:im.map(t=>c.jsx("button",{className:`chip ${t===e?"active":""}`,type:"button",onClick:()=>n(t),children:t},t))})}function om({items:e}){const[n,t]=S.useState(0);if(!(e!=null&&e.length))return null;const r=e[n],i=()=>t(o=>(o+1)%e.length),l=()=>t(o=>(o-1+e.length)%e.length);return c.jsxs("div",{className:"featured-carousel",children:[c.jsxs("div",{className:"featured-card",children:[c.jsxs("div",{className:"featured-meta",children:[c.jsx("span",{className:"pill",children:"Featured"}),r.tag&&c.jsx("span",{className:"pill",children:r.tag})]}),c.jsx("h3",{children:r.title}),c.jsx("p",{children:r.description}),c.jsx("div",{className:"project-tags",children:(r.tags||[]).map(o=>c.jsx("span",{className:"pill",children:o},o))}),c.jsx("div",{className:"featured-actions",children:c.jsx("a",{href:r.href,target:"_blank",rel:"noreferrer",className:"link-button",children:"View"})})]}),e.length>1&&c.jsxs("div",{className:"featured-controls",children:[c.jsx("button",{type:"button",onClick:l,className:"button ghost",children:"←"}),c.jsx("button",{type:"button",onClick:i,className:"button ghost",children:"→"})]})]})}function sm({items:e,showViewAll:n=!1,showHeader:t=!0}){const[r,i]=S.useState("All"),[l,o]=S.useState(1),s=4,a=e.slice(0,2),u=S.useMemo(()=>r==="All"?e:e.filter(v=>{var w;return(w=v.tags)==null?void 0:w.some(k=>k.toLowerCase().includes(r.toLowerCase().split(" ")[0]))}),[r,e]),g=Math.max(1,Math.ceil(u.length/s)),h=u.slice((l-1)*s,l*s),m=v=>{i(v),o(1)};return c.jsx("section",{className:"projects",id:"projects",children:c.jsxs("div",{className:"container",children:[t&&c.jsxs("div",{className:"section-header",children:[c.jsxs("div",{children:[c.jsx("h2",{className:"section-title",children:"Projects"}),c.jsx("p",{className:"section-subtitle",children:"Every project is a unique endeavor. See what I have accomplished so far!"})]}),n&&c.jsx("div",{className:"section-actions",children:c.jsx(Ue,{className:"link-button",to:"/projects",children:"View all projects"})})]}),t&&c.jsx(lm,{activeFilter:r,onFilterChange:m}),t&&c.jsx(om,{items:a}),c.jsx("div",{className:"projects-list",children:h.map(v=>{var w;return c.jsxs("div",{className:"project-row",children:[c.jsxs("div",{className:"project-row-body",children:[c.jsx("a",{href:v.href,target:"_blank",rel:"noreferrer",className:"project-title-link",children:c.jsx("h5",{className:"project-title",children:v.title})}),c.jsx("p",{className:"project-description",children:v.description}),(w=v.tags)!=null&&w.length?c.jsx("div",{className:"project-tags",children:v.tags.map(k=>c.jsx("span",{className:"pill",children:k},k))}):null]}),c.jsx("div",{className:"project-row-cta",children:c.jsx("a",{href:v.href,target:"_blank",rel:"noreferrer",className:"view-credentials",children:"View"})})]},v.title)})}),g>1&&c.jsxs("div",{className:"blog-pagination project-pagination",children:[c.jsx("button",{className:"pill",disabled:l===1,onClick:()=>o(Math.max(1,l-1)),children:"Previous"}),c.jsxs("span",{className:"blog-page-indicator",children:["Page ",l," of ",g]}),c.jsx("button",{className:"pill",disabled:l===g,onClick:()=>o(Math.min(g,l+1)),children:"Next"})]})]})})}function am(){return c.jsxs(c.Fragment,{children:[c.jsx("header",{className:"blog-welcome-section",children:c.jsxs("div",{className:"container text-center",children:[c.jsx("h1",{children:"Projects"}),c.jsx("p",{className:"blog-subtitle",children:"A focused list of what I’ve shipped and explored."})]})}),c.jsx(sm,{items:Dh,showHeader:!1})]})}function um({issuer:e="Cert"}){var t;const n=((t=e==null?void 0:e[0])==null?void 0:t.toUpperCase())||"C";return c.jsx("div",{className:"cert-badge",children:n})}const cm=["All","Security","Cloud","Networking"];function dm({items:e,showViewAll:n=!1,showHeader:t=!0}){const[r,i]=S.useState("All"),[l,o]=S.useState(1),s=5,a=S.useMemo(()=>r==="All"?e:e.filter(m=>m.domain?m.domain===r:!0),[r,e]),u=Math.max(1,Math.ceil(a.length/s)),g=a.slice((l-1)*s,l*s),h=m=>{i(m),o(1)};return c.jsx("section",{className:"certifications",id:"certs",children:c.jsxs("div",{className:"container",children:[t&&c.jsxs("div",{className:"section-header",children:[c.jsx("div",{children:c.jsx("h2",{children:"CERTIFICATIONS"})}),n&&c.jsx("div",{className:"section-actions",children:c.jsx(Ue,{className:"link-button",to:"/certifications",children:"View all certifications"})})]}),t&&c.jsx("div",{className:"filter-chips",children:cm.map(m=>c.jsx("button",{className:`chip ${m===r?"active":""}`,type:"button",onClick:()=>h(m),children:m},m))}),c.jsx("div",{className:"cert-list",children:g.map(m=>c.jsxs("div",{className:"cert-row",children:[c.jsxs("div",{className:"cert-row-meta",children:[c.jsx("div",{className:"cert-row-badge",children:c.jsx(um,{issuer:m.issuer})}),c.jsxs("div",{className:"cert-row-tags",children:[c.jsx("span",{className:"pill",children:m.domain}),c.jsx("span",{className:"pill",children:m.issuer})]})]}),c.jsxs("div",{className:"cert-row-body",children:[c.jsx("div",{className:"cert-row-title",children:m.title}),c.jsx("p",{className:"cert-row-details",children:m.details})]}),c.jsx("div",{className:"cert-row-cta",children:c.jsx("a",{href:m.href,className:"view-credentials",target:"_blank",rel:"noreferrer",children:"View"})})]},m.title))}),u>1&&c.jsxs("div",{className:"blog-pagination project-pagination",children:[c.jsx("button",{className:"pill",disabled:l===1,onClick:()=>o(Math.max(1,l-1)),children:"Previous"}),c.jsxs("span",{className:"blog-page-indicator",children:["Page ",l," of ",u]}),c.jsx("button",{className:"pill",disabled:l===u,onClick:()=>o(Math.min(u,l+1)),children:"Next"})]})]})})}function fm(){return c.jsxs(c.Fragment,{children:[c.jsx("header",{className:"blog-welcome-section",children:c.jsxs("div",{className:"container text-center",children:[c.jsx("h1",{children:"Certifications"}),c.jsx("p",{className:"blog-subtitle",children:"Credentials and exams I’ve completed."})]})}),c.jsx(dm,{items:zh,showHeader:!1})]})}function pm(){const e="hemparekh1596@gmail.com",n=()=>{navigator.clipboard&&navigator.clipboard.writeText(e).catch(()=>{})};return c.jsx("section",{className:"contact-strip",id:"contact",children:c.jsxs("div",{className:"container contact-grid",children:[c.jsxs("div",{children:[c.jsx("p",{className:"pill",children:"Let’s talk"}),c.jsx("h2",{children:"Get in touch"}),c.jsx("p",{className:"contact-blurb",children:"Let’s connect to collaborate on security engineering or privacy-focused initiatives."})]}),c.jsxs("div",{className:"contact-actions",children:[c.jsx("button",{className:"button primary",onClick:n,type:"button",children:"Copy Email"}),c.jsx("a",{className:"button ghost",href:"https://www.linkedin.com/in/hem-parekh/",target:"_blank",rel:"noreferrer",children:"LinkedIn"}),c.jsx("a",{className:"button ghost",href:"https://github.com/Hem1700",target:"_blank",rel:"noreferrer",children:"GitHub"})]})]})})}function hm(){const[e,n]=S.useState(0);return S.useEffect(()=>{const t=()=>{const{scrollTop:r,scrollHeight:i,clientHeight:l}=document.documentElement,o=i>l?r/(i-l)*100:0;n(Math.min(100,Math.max(0,o)))};return t(),window.addEventListener("scroll",t,{passive:!0}),()=>window.removeEventListener("scroll",t)},[]),c.jsx("div",{className:"scroll-progress",children:c.jsx("div",{className:"scroll-progress__bar",style:{width:`${e}%`}})})}function mm(){const[e,n]=S.useState(!1);return S.useEffect(()=>{const t=()=>n(window.scrollY>400);return window.addEventListener("scroll",t,{passive:!0}),t(),()=>window.removeEventListener("scroll",t)},[]),e?c.jsx("button",{className:"back-to-top",type:"button","aria-label":"Back to top",onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),children:"↑"}):null}function gm(){const[e,n]=S.useState(()=>typeof window>"u"?"light":localStorage.getItem("theme")||"light");return S.useEffect(()=>{const r=document.body;r.classList.remove("light","dark"),r.classList.add(e),localStorage.setItem("theme",e)},[e]),{theme:e,toggleTheme:()=>{n(r=>r==="light"?"dark":"light")}}}function vm(){const{theme:e,toggleTheme:n}=gm();return c.jsx(Sh,{children:c.jsxs("div",{className:"app-shell",children:[c.jsx(hm,{}),c.jsx(Th,{onToggleTheme:n,theme:e}),c.jsx("main",{children:c.jsxs(mh,{children:[c.jsx(Tn,{path:"/",element:c.jsx(wa,{})}),c.jsx(Tn,{path:"/blogs",element:c.jsx(Vh,{})}),c.jsx(Tn,{path:"/projects",element:c.jsx(am,{})}),c.jsx(Tn,{path:"/certifications",element:c.jsx(fm,{})}),c.jsx(Tn,{path:"/blog/:slug",element:c.jsx(rm,{})}),c.jsx(Tn,{path:"*",element:c.jsx(wa,{})})]})}),c.jsx(pm,{}),c.jsx(Ph,{}),c.jsx(mm,{})]})})}Rc(document.getElementById("root")).render(c.jsx(La.StrictMode,{children:c.jsx(vm,{})}));
