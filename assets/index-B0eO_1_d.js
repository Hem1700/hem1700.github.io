...
</html>`,em={firmware_llm_annotator:{title:"Firmware Exploration: LLM as Your Annotator",slug:"firmware_llm_annotator",content:Xh},1001:{title:"CVE-2024–1001",slug:"1001",content:$h},"0012":{title:"CVE-2024–0012",slug:"0012",content:Vh},40982:{title:"CVE-2022–40982",slug:"40982",content:Kh},cow:{title:"CVE-2016–5195",slug:"cow",content:Yh},symlinks:{title:"Symbolic Links (Symlinks) in Linux",slug:"symlinks",content:Zh},23397:{title:"CVE-2023–23397",slug:"23397",content:Qh},"0160":{title:"CVE-2014-0160",slug:"0160",content:Wh},11882:{title:"CVE-2017-11882",slug:"11882",content:Gh},robot:{title:"ROBOT (Return of Bleichenbacher’s Oracle Threat) Attack",slug:"robot",content:qh},poodle:{title:"ZOMBIE POODLE and GOLDENDOODLE ATTACKS",slug:"poodle",content:Jh}};function nm(e){try{const t=new DOMParser().parseFromString(e,"text/html");return t.querySelectorAll("style").forEach(i=>i.remove()),t.body?t.body.innerHTML:e}catch{return e}}function tm(){const{slug:e}=Zp(),n=em[e],t=no.find(l=>l.slug===e),r=S.useMemo(()=>{if(!n)return[];const o=new DOMParser().parseFromString(n.content,"text/html");return Array.from(o.querySelectorAll("h2, h3")).map((s,a)=>({text:s.textContent||`Section ${a+1}`,id:`toc-${a}`,tag:s.tagName.toLowerCase()}))},[n]),i=S.useMemo(()=>{if(!n)return"";const o=new DOMParser().parseFromString(n.content,"text/html");return Array.from(o.querySelectorAll("h2, h3")).forEach((s,a)=>{s.id=`toc-${a}`}),nm(o.documentElement.outerHTML)},[n]);return n?c.jsxs(c.Fragment,{children:[c.jsx("header",{className:"blog-post-header",children:c.jsxs("div",{className:"container text-center",children:[c.jsx("h1",{className:"blog-post-title",children:n.title}),t&&c.jsxs("p",{className:"blog-post-date",children:[t.date," · ",t.readTime]})]})}),c.jsxs("main",{className:"blog-post-content container",children:[r.length>0&&c.jsxs("aside",{className:"post-toc",children:[c.jsx("p",{className:"pill",children:"On this page"}),c.jsx("ul",{children:r.map(l=>c.jsx("li",{className:l.tag==="h3"?"toc-sub":"",children:c.jsx("a",{href:`#${l.id}`,children:l.text})},l.id))})]}),c.jsx("article",{dangerouslySetInnerHTML:{__html:i}})]})]}):c.jsxs("main",{className:"blog-post-content container",children:[c.jsx("h2",{children:"Post not found"}),c.jsx("p",{children:"The post you’re looking for does not exist."}),c.jsx(Ge,{to:"/blogs",className:"view-credentials",children:"Back to Blog"})]})}function rm({items:e}){return e!=null&&e.length?c.jsx("div",{className:"featured-projects",children:e.map(n=>c.jsxs("a",{href:n.href,target:"_blank",rel:"noreferrer",className:"featured-card",children:[c.jsxs("div",{className:"featured-meta",children:[c.jsx("span",{className:"pill",children:"Featured"}),c.jsx("span",{className:"pill",children:n.tag||"Security"})]}),c.jsx("h3",{children:n.title}),c.jsx("p",{children:n.description}),c.jsx("div",{className:"project-tags",children:(n.tags||["Security"]).map(t=>c.jsx("span",{className:"pill",children:t},t))})]},n.title))}):null}const im=["All","Security Tools","Research","Web","Desktop","Cloud","Automation"];function lm({activeFilter:e,onFilterChange:n}){return c.jsx("div",{className:"filter-chips",children:im.map(t=>c.jsx("button",{className:`chip ${t===e?"active":""}`,type:"button",onClick:()=>n(t),children:t},t))})}function om({items:e,showViewAll:n=!1,showHeader:t=!0}){const[r,i]=S.useState("All"),l=e.slice(0,2),o=S.useMemo(()=>r==="All"?e:e.filter(s=>{var a;return(a=s.tags)==null?void 0:a.some(u=>u.toLowerCase().includes(r.toLowerCase().split(" ")[0]))}),[r,e]);return c.jsx("section",{className:"projects",id:"projects",children:c.jsxs("div",{className:"container",children:[t&&c.jsxs("div",{className:"section-header",children:[c.jsxs("div",{children:[c.jsx("h2",{className:"section-title",children:"Projects"}),c.jsx("p",{className:"section-subtitle",children:"Every project is a unique endeavor. See what I have accomplished so far!"})]}),n&&c.jsx("div",{className:"section-actions",children:c.jsx(Ge,{className:"link-button",to:"/projects",children:"View all projects"})})]}),t&&c.jsx(lm,{activeFilter:r,onFilterChange:i}),t&&c.jsx(rm,{items:l}),c.jsx("div",{className:"projects-grid",children:o.map(s=>{var a;return c.jsx("div",{className:"project-card",children:c.jsxs("a",{href:s.href,target:"_blank",rel:"noreferrer",children:[c.jsx("h5",{className:"project-title",children:s.title}),c.jsx("p",{className:"project-description",children:s.description}),(a=s.tags)!=null&&a.length?c.jsx("div",{className:"project-tags",children:s.tags.map(u=>c.jsx("span",{className:"pill",children:u},u))}):null]})},s.title)})})]})})}function sm(){return c.jsxs(c.Fragment,{children:[c.jsx("header",{className:"blog-welcome-section",children:c.jsxs("div",{className:"container text-center",children:[c.jsx("h1",{children:"Projects"}),c.jsx("p",{className:"blog-subtitle",children:"A focused list of what I’ve shipped and explored."})]})}),c.jsx(om,{items:Ih,showHeader:!1})]})}const am=["All","Security","Cloud","Networking"];function um({items:e,showViewAll:n=!1,showHeader:t=!0}){const[r,i]=S.useState("All"),l=S.useMemo(()=>r==="All"?e:e.filter(o=>o.domain?o.domain===r:!0),[r,e]);return c.jsx("section",{className:"certifications",id:"certs",children:c.jsxs("div",{className:"container",children:[t&&c.jsxs("div",{className:"section-header",children:[c.jsx("div",{children:c.jsx("h2",{children:"CERTIFICATIONS"})}),n&&c.jsx("div",{className:"section-actions",children:c.jsx(Ge,{className:"link-button",to:"/certifications",children:"View all certifications"})})]}),t&&c.jsx("div",{className:"filter-chips",children:am.map(o=>c.jsx("button",{className:`chip ${o===r?"active":""}`,type:"button",onClick:()=>i(o),children:o},o))}),c.jsx("div",{className:"cert-grid",children:l.map(o=>c.jsxs("div",{className:"cert-item",children:[c.jsx("div",{className:"cert-title",children:c.jsx("span",{children:o.title})}),c.jsxs("div",{className:"cert-content",children:[c.jsx("p",{children:o.details}),c.jsx("a",{href:o.href,className:"view-credentials",target:"_blank",rel:"noreferrer",children:"View credentials"})]})]},o.title))})]})})}function cm(){return c.jsxs(c.Fragment,{children:[c.jsx("header",{className:"blog-welcome-section",children:c.jsxs("div",{className:"container text-center",children:[c.jsx("h1",{children:"Certifications"}),c.jsx("p",{className:"blog-subtitle",children:"Credentials and exams I’ve completed."})]})}),c.jsx(um,{items:Dh,showHeader:!1})]})}function dm(){const e="hemparekh1596@gmail.com",n=()=>{navigator.clipboard&&navigator.clipboard.writeText(e).catch(()=>{})};return c.jsx("section",{className:"contact-strip",id:"contact",children:c.jsxs("div",{className:"container contact-grid",children:[c.jsxs("div",{children:[c.jsx("p",{className:"pill",children:"Let’s talk"}),c.jsx("h2",{children:"Get in touch"}),c.jsx("p",{className:"contact-blurb",children:"Open to security engineering, privacy engineering, and penetration testing roles."})]}),c.jsxs("div",{className:"contact-actions",children:[c.jsx("button",{className:"button primary",onClick:n,type:"button",children:"Copy Email"}),c.jsx("a",{className:"button ghost",href:"https://www.linkedin.com/in/hem-parekh/",target:"_blank",rel:"noreferrer",children:"LinkedIn"}),c.jsx("a",{className:"button ghost",href:"https://github.com/Hem1700",target:"_blank",rel:"noreferrer",children:"GitHub"})]})]})})}function fm(){const[e,n]=S.useState(0);return S.useEffect(()=>{const t=()=>{const{scrollTop:r,scrollHeight:i,clientHeight:l}=document.documentElement,o=i>l?r/(i-l)*100:0;n(Math.min(100,Math.max(0,o)))};return t(),window.addEventListener("scroll",t,{passive:!0}),()=>window.removeEventListener("scroll",t)},[]),c.jsx("div",{className:"scroll-progress",children:c.jsx("div",{className:"scroll-progress__bar",style:{width:`${e}%`}})})}function pm(){const[e,n]=S.useState(!1);return S.useEffect(()=>{const t=()=>n(window.scrollY>400);return window.addEventListener("scroll",t,{passive:!0}),t(),()=>window.removeEventListener("scroll",t)},[]),e?c.jsx("button",{className:"back-to-top",type:"button","aria-label":"Back to top",onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),children:"↑"}):null}function hm(){const[e,n]=S.useState(()=>typeof window>"u"?"light":localStorage.getItem("theme")||"light");return S.useEffect(()=>{const r=document.body;r.classList.remove("light","dark"),r.classList.add(e),localStorage.setItem("theme",e)},[e]),{theme:e,toggleTheme:()=>{n(r=>r==="light"?"dark":"light")}}}function mm(){const{theme:e,toggleTheme:n}=hm();return c.jsx(Sh,{children:c.jsxs("div",{className:"app-shell",children:[c.jsx(fm,{}),c.jsx(Th,{onToggleTheme:n,theme:e}),c.jsx("main",{children:c.jsxs(mh,{children:[c.jsx(Tn,{path:"/",element:c.jsx(wa,{})}),c.jsx(Tn,{path:"/blogs",element:c.jsx(Hh,{})}),c.jsx(Tn,{path:"/projects",element:c.jsx(sm,{})}),c.jsx(Tn,{path:"/certifications",element:c.jsx(cm,{})}),c.jsx(Tn,{path:"/blog/:slug",element:c.jsx(tm,{})}),c.jsx(Tn,{path:"*",element:c.jsx(wa,{})})]})}),c.jsx(dm,{}),c.jsx(Ph,{}),c.jsx(pm,{})]})})}jc(document.getElementById("root")).render(c.jsx(Na.StrictMode,{children:c.jsx(mm,{})}));
