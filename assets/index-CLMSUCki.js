...
bio: ${Fc.blurb}`})}),b.jsx(Mt,{title:"experience",id:"experience",children:b.jsx("ul",{className:"terminal-list",children:Yg.map(e=>b.jsxs("li",{children:[e.role," @ ",e.org," [",e.range,"]"]},`${e.role}-${e.range}`))})}),b.jsxs(Mt,{title:"about",id:"about",children:[b.jsx("p",{className:"terminal-text",children:$g.text}),b.jsx("div",{className:"terminal-list inline",children:Wg.map(e=>b.jsx("a",{href:e.href,target:"_blank",rel:"noreferrer",children:e.label},e.href))})]})]})}function Xg(){return b.jsx("div",{className:"terminal-feed",children:b.jsx(Mt,{title:"blogs",children:b.jsx("ul",{className:"terminal-list",children:zd.map(e=>b.jsxs("li",{children:[b.jsx(Ct,{to:`/blog/${e.slug}`,children:e.title})," — ",e.excerpt]},e.slug))})})})}const Kg=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
