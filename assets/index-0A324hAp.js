 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(E,L){var R=E.length;E.push(L);e:for(;0<R;){var D=R-1>>>1,B=E[D];if(0<r(B,L))E[D]=L,E[R]=B,R=D;else break e}}function t(E){return E.length===0?null:E[0]}function s(E){if(E.length===0)return null;var L=E[0],R=E.pop();if(R!==L){E[0]=R;e:for(var D=0,B=E.length,ye=B>>>1;D<ye;){var $=2*(D+1)-1,ve=E[$],oe=$+1,de=E[oe];if(0>r(ve,R))oe<B&&0>r(de,ve)?(E[D]=de,E[oe]=R,D=oe):(E[D]=ve,E[$]=R,D=$);else if(oe<B&&0>r(de,R))E[D]=de,E[oe]=R,D=oe;else break e}}return L}function r(E,L){var R=E.sortIndex-L.sortIndex;return R!==0?R:E.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var o=[],c=[],u=1,d=null,f=3,g=!1,b=!1,y=!1,k=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(E){for(var L=t(c);L!==null;){if(L.callback===null)s(c);else if(L.startTime<=E)s(c),L.sortIndex=L.expirationTime,n(o,L);else break;L=t(c)}}function v(E){if(y=!1,m(E),!b)if(t(o)!==null)b=!0,S(_);else{var L=t(c);L!==null&&z(v,L.startTime-E)}}function _(E,L){b=!1,y&&(y=!1,h(N),N=-1),g=!0;var R=f;try{for(m(L),d=t(o);d!==null&&(!(d.expirationTime>L)||E&&!W());){var D=d.callback;if(typeof D=="function"){d.callback=null,f=d.priorityLevel;var B=D(d.expirationTime<=L);L=e.unstable_now(),typeof B=="function"?d.callback=B:d===t(o)&&s(o),m(L)}else s(o);d=t(o)}if(d!==null)var ye=!0;else{var $=t(c);$!==null&&z(v,$.startTime-L),ye=!1}return ye}finally{d=null,f=R,g=!1}}var C=!1,P=null,N=-1,j=5,M=-1;function W(){return!(e.unstable_now()-M<j)}function se(){if(P!==null){var E=e.unstable_now();M=E;var L=!0;try{L=P(!0,E)}finally{L?ee():(C=!1,P=null)}}else C=!1}var ee;if(typeof p=="function")ee=function(){p(se)};else if(typeof MessageChannel<"u"){var x=new MessageChannel,O=x.port2;x.port1.onmessage=se,ee=function(){O.postMessage(null)}}else ee=function(){k(se,0)};function S(E){P=E,C||(C=!0,ee())}function z(E,L){N=k(function(){E(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){b||g||(b=!0,S(_))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return t(o)},e.unstable_next=function(E){switch(f){case 1:case 2:case 3:var L=3;break;default:L=f}var R=f;f=L;try{return E()}finally{f=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,L){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var R=f;f=E;try{return L()}finally{f=R}},e.unstable_scheduleCallback=function(E,L,R){var D=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?D+R:D):R=D,E){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=R+B,E={id:u++,callback:L,priorityLevel:E,startTime:R,expirationTime:B,sortIndex:-1},R>D?(E.sortIndex=R,n(c,E),t(o)===null&&E===t(c)&&(y?(h(N),N=-1):y=!0,z(v,R-D))):(E.sortIndex=B,n(o,E),b||g||(b=!0,S(_))),E},e.unstable_shouldYield=W,e.unstable_wrapCallback=function(E){var L=f;return function(){var R=f;f=L;try{return E.apply(this,arguments)}finally{f=R}}}})(Eu);Su.exports=Eu;var Rh=Su.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function js(){return js=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var s in t)Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s])}return e},js.apply(this,arguments)}const uo=T.createContext(null),pg=T.createContext(null),ht=T.createContext(null),Ai=T.createContext(null),Yn=T.createContext({outlet:null,matches:[],isDataRoute:!1}),Nd=T.createContext(null);function dg(e,n){let{relative:t}=n===void 0?{}:n;qs()||te(!1);let{basename:s,navigator:r}=T.useContext(ht),{hash:i,pathname:a,search:l}=Od(e,{relative:t}),o=a;return s!=="/"&&(o=a==="/"?s:Un([s,a])),r.createHref({pathname:o,search:l,hash:i})}function qs(){return T.useContext(Ai)!=null}function Xs(){return qs()||te(!1),T.useContext(Ai).location}function Ld(e){T.useContext(ht).static||T.useLayoutEffect(e)}function Rd(){let{isDataRoute:e}=T.useContext(Yn);return e?Tg():hg()}function hg(){qs()||te(!1);let e=T.useContext(uo),{basename:n,future:t,navigator:s}=T.useContext(ht),{matches:r}=T.useContext(Yn),{pathname:i}=Xs(),a=JSON.stringify(Cd(r,t.v7_relativeSplatPath)),l=T.useRef(!1);return Ld(()=>{l.current=!0}),T.useCallback(function(c,u){if(u===void 0&&(u={}),!l.current)return;if(typeof c=="number"){s.go(c);return}let d=Ad(c,JSON.parse(a),i,u.relative==="path");e==null&&n!=="/"&&(d.pathname=d.pathname==="/"?n:Un([n,d.pathname])),(u.replace?s.replace:s.push)(d,u.state,u)},[n,s,a,i,e])}function fg(){let{matches:e}=T.useContext(Yn),n=e[e.length-1];return n?n.params:{}}function Od(e,n){let{relative:t}=n===void 0?{}:n,{future:s}=T.useContext(ht),{matches:r}=T.useContext(Yn),{pathname:i}=Xs(),a=JSON.stringify(Cd(r,s.v7_relativeSplatPath));return T.useMemo(()=>Ad(e,JSON.parse(a),i,t==="path"),[e,a,i,t])}function mg(e,n){return gg(e,n)}function gg(e,n,t,s){qs()||te(!1);let{navigator:r}=T.useContext(ht),{matches:i}=T.useContext(Yn),a=i[i.length-1],l=a?a.params:{};a&&a.pathname;let o=a?a.pathnameBase:"/";a&&a.route;let c=Xs(),u;if(n){var d;let k=typeof n=="string"?qt(n):n;o==="/"||(d=k.pathname)!=null&&d.startsWith(o)||te(!1),u=k}else u=c;let f=u.pathname||"/",g=f;if(o!=="/"){let k=o.replace(/^\//,"").split("/");g="/"+f.replace(/^\//,"").split("/").slice(k.length).join("/")}let b=Um(e,{pathname:g}),y=bg(b&&b.map(k=>Object.assign({},k,{params:Object.assign({},l,k.params),pathname:Un([o,r.encodeLocation?r.encodeLocation(k.pathname).pathname:k.pathname]),pathnameBase:k.pathnameBase==="/"?o:Un([o,r.encodeLocation?r.encodeLocation(k.pathnameBase).pathname:k.pathnameBase])})),i,t,s);return n&&y?T.createElement(Ai.Provider,{value:{location:js({pathname:"/",search:"",hash:"",state:null,key:"default"},u),navigationType:Ln.Pop}},y):y}function yg(){let e=Eg(),n=cg(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),t=e instanceof Error?e.stack:null,r={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return T.createElement(T.Fragment,null,T.createElement("h2",null,"Unexpected Application Error!"),T.createElement("h3",{style:{fontStyle:"italic"}},n),t?T.createElement("pre",{style:r},t):null,null)}const vg=T.createElement(yg,null);class wg extends T.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,t){return t.location!==n.location||t.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error!==void 0?n.error:t.error,location:t.location,revalidation:n.revalidation||t.revalidation}}componentDidCatch(n,t){console.error("React Router caught the following error during render",n,t)}render(){return this.state.error!==void 0?T.createElement(Yn.Provider,{value:this.props.routeContext},T.createElement(Nd.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function kg(e){let{routeContext:n,match:t,children:s}=e,r=T.useContext(uo);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),T.createElement(Yn.Provider,{value:n},s)}function bg(e,n,t,s){var r;if(n===void 0&&(n=[]),t===void 0&&(t=null),s===void 0&&(s=null),e==null){var i;if(!t)return null;if(t.errors)e=t.matches;else if((i=s)!=null&&i.v7_partialHydration&&n.length===0&&!t.initialized&&t.matches.length>0)e=t.matches;else return null}let a=e,l=(r=t)==null?void 0:r.errors;if(l!=null){let u=a.findIndex(d=>d.route.id&&(l==null?void 0:l[d.route.id])!==void 0);u>=0||te(!1),a=a.slice(0,Math.min(a.length,u+1))}let o=!1,c=-1;if(t&&s&&s.v7_partialHydration)for(let u=0;u<a.length;u++){let d=a[u];if((d.route.HydrateFallback||d.route.hydrateFallbackElement)&&(c=u),d.route.id){let{loaderData:f,errors:g}=t,b=d.route.loader&&f[d.route.id]===void 0&&(!g||g[d.route.id]===void 0);if(d.route.lazy||b){o=!0,c>=0?a=a.slice(0,c+1):a=[a[0]];break}}}return a.reduceRight((u,d,f)=>{let g,b=!1,y=null,k=null;t&&(g=l&&d.route.id?l[d.route.id]:void 0,y=d.route.errorElement||vg,o&&(c<0&&f===0?(Cg("route-fallback"),b=!0,k=null):c===f&&(b=!0,k=d.route.hydrateFallbackElement||null)));let h=n.concat(a.slice(0,f+1)),p=()=>{let m;return g?m=y:b?m=k:d.route.Component?m=T.createElement(d.route.Component,null):d.route.element?m=d.route.element:m=u,T.createElement(kg,{match:d,routeContext:{outlet:u,matches:h,isDataRoute:t!=null},children:m})};return t&&(d.route.ErrorBoundary||d.route.errorElement||f===0)?T.createElement(wg,{location:t.location,revalidation:t.revalidation,component:y,error:g,children:p(),routeContext:{outlet:null,matches:h,isDataRoute:!0}}):p()},null)}var Md=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(Md||{}),Id=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(Id||{});function xg(e){let n=T.useContext(uo);return n||te(!1),n}function _g(e){let n=T.useContext(pg);return n||te(!1),n}function Sg(e){let n=T.useContext(Yn);return n||te(!1),n}function zd(e){let n=Sg(),t=n.matches[n.matches.length-1];return t.route.id||te(!1),t.route.id}function Eg(){var e;let n=T.useContext(Nd),t=_g(),s=zd();return n!==void 0?n:(e=t.errors)==null?void 0:e[s]}function Tg(){let{router:e}=xg(Md.UseNavigateStable),n=zd(Id.UseNavigateStable),t=T.useRef(!1);return Ld(()=>{t.current=!0}),T.useCallback(function(r,i){i===void 0&&(i={}),t.current&&(typeof r=="number"?e.navigate(r):e.navigate(r,js({fromRouteId:n},i)))},[e,n])}const Dc={};function Cg(e,n,t){Dc[e]||(Dc[e]=!0)}function Ag(e,n){e==null||e.v7_startTransition,e==null||e.v7_relativeSplatPath}function _n(e){te(!1)}function Pg(e){let{basename:n="/",children:t=null,location:s,navigationType:r=Ln.Pop,navigator:i,static:a=!1,future:l}=e;qs()&&te(!1);let o=n.replace(/^\/*/,"/"),c=T.useMemo(()=>({basename:o,navigator:i,static:a,future:js({v7_relativeSplatPath:!1},l)}),[o,l,i,a]);typeof s=="string"&&(s=qt(s));let{pathname:u="/",search:d="",hash:f="",state:g=null,key:b="default"}=s,y=T.useMemo(()=>{let k=co(u,o);return k==null?null:{location:{pathname:k,search:d,hash:f,state:g,key:b},navigationType:r}},[o,u,d,f,g,b,r]);return y==null?null:T.createElement(ht.Provider,{value:c},T.createElement(Ai.Provider,{children:t,value:y}))}function Ng(e){let{children:n,location:t}=e;return mg(sl(n),t)}new Promise(()=>{});function sl(e,n){n===void 0&&(n=[]);let t=[];return T.Children.forEach(e,(s,r)=>{if(!T.isValidElement(s))return;let i=[...n,r];if(s.type===T.Fragment){t.push.apply(t,sl(s.props.children,i));return}s.type!==_n&&te(!1),!s.props.index||!s.props.children||te(!1);let a={id:s.props.id||i.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(a.children=sl(s.props.children,i)),t.push(a)}),t}/**
